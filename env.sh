...
export CONCORD_RDTSC_PASS=$CONCORD_SRC_PATH/rdtsc-pass/build/src/libConcordPass.so
export CONCORD_CACHE_LINE_PASS=$CONCORD_SRC_PATH/cache-line-pass/build/src/libConcordPass.so
